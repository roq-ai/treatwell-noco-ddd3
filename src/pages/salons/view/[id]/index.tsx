...
import { getSalonById } from 'apiSdk/salons';
...
function SalonViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<SalonInterface>(
    ...
    () =>
      getSalonById(id, {
        relations: ['user', 'appointment', 'customer'],
      }),
  );
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('salon', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/salons/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('appointment', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/appointments/create?salon_id=${data?.id}`}>
              ...
              {hasAccess('customer', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/customers/create?salon_id=${data?.id}`}>
                      <Button colorScheme="blue" mr="4" as="a">
                        Create
                      </Button>
                    </NextLink>
